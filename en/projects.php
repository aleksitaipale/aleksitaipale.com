  <section class="color2">
    ...
    <div class="row">
      <div class="large-12 columns"><h2>Works</h2></div>
    </div>
    <div class="row hisrc projectsList">
        ...
        <ul class="small-block-grid-1 medium-block-grid-2 large-block-grid-3 projectList">
         ...
         <li>
          <a href="aleksitaipalecom.php">
           ...
           <p>My portfolio site (The one you're on now!)</p>
         </a>
       </li>
       <li>
        <a href="lyrae.php">
          ...
          <h4>Lyrae</h4>
          <p>A lyric sharing site for two, s'il vous plaît</p>
        </a>
      </li>
      <li><a href="tila.php"><img src="../img/resized/tilabanner-small.png" data-1x="../img/resized/tilabanner-large.png" data-2x="../img/resized/tilabanner-retina.png">
        <h4>Tila</h4>
        <p>An Underscores-based Wordpress blog</p>
      </a>
    </li>
    <li>
      <a href="goelg.php">
        ...
        <h4>Goelg</h4>
        <p>A splash page for a techno musician</p>
      </a>
    </li>
  </ul>
</div>
